   ...
   if( $event['message']['type'] == 'text' )
   {
		...
		if(($text == "อุณหภูมิตอนนี้")||($text == "อยากทราบยอด COVID-19 ครับ")||($text == "อยากทราบยอด COVID-19")
		   ||($text == "ยอดCOVID-19")||($text == "ยอด COVID-19")||($text == "ยอด COVID19")||($text == "COVID-19")||($text == "COVID19")){
			...
			$Deceased = "17,365";
			$Healed = "103,753";
			$reply_message = "รายงานสถานการณ์ ยอดผู้ติดเชื้อไวรัสโคโรนา 2019 (COVID-19) ในประเทศไทย ผู้ป่วยสะสม จำนวน ".$Collector_patients." ราย<br>"
				."ผู้เสียชีวิต จำนวน ".$Deceased." ราย<br> รักษาหาย จำนวน ".$Healed." ราย<br>ผู้รายงานข้อมูล: นายจิรายุ ปฐมรัตนศิริ";
		}
